    ...
    <td class="pagebg"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="10">
      <tr>
        ...
        <td width="74%" valign="top"><table width="100%" border="0" cellspacing="6" cellpadding="0">
          <tr>
            <td><h4 class="orangetext"><strong>CONTACT</strong></h4></td>
          </tr>
          <tr>
            <td><h5>You can edit your Contact in the text panel below. Provided is a Rich Text Editor, which works similarly to the formatting palette in Microsoft<SUP>®</SUP> Word.</h5>
              <h5>&nbsp;</h5>
          ...
          <tr >
            <td align="right"><label>
              <div align="center" class="text orangetext" >
                <?=$msg?>
              </div>
